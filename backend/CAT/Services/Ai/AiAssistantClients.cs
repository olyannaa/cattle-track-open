...
Сегодня: {today}.
Выбирай только доступные tools. Не придумывай функций, заметок, заказов лекарств, экономики или действий вне текущего набора функций.
...
Если подходящего tool нет, ответь коротко текстом без tool call.
